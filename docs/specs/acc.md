...
### A2X — pages are bound by readable rows, not raw rows (`ACC-14`)
...
- 2026-09-25 — ACC-14 page-fill evidence landed (`t-b694bc83`):
  ...
  (A2X). The landing fixed the leak as a bug; requirement wording is
