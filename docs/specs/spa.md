...
- `2026-09-19` — `t-4b9501b3` added the INTEGRATION coverage of the JSON boundary over real
  ...
  Three divergences from the contract were found and are held by `#[ignore]`d cases carrying
